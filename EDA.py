  ...
  if option == "Station-Based Analysis":
    ...
    with tab5:
      ...
      for i in range(len(pollutants)):
          ...
          status_counts = combined_dataFrame.groupby('station')[aqi_column].value_counts().unstack()
          ax = status_counts.plot(kind='bar', stacked=True, figsize=(10, 6),color=['green', 'yellow', 'red'])
